const Footer = () => {
  return (
    <footer className="bg-[#83B4FF] mt-5">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-3">
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-black sm:text-center">
            © 2025 <a className="hover:underline">Koddydogs</a>
          </span>

          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <span className="flex text-sm text-black sm:text-center items-center justify-center max-sm:text-xs -mt-4">
              <button className="hover:text-white text-black border-2 inline-flex items-center mr-4 last-of-type:mr-0 p-2.5 border-transparent bg-light-secondary shadow-button-flat-nopressed hover:border-2 hover:shadow-button-flat-pressed focus:opacity-100 focus:outline-none active:border-2 active:shadow-button-flat-pressed font-medium rounded-full text-sm text-center">
            ...
            <a
              ...
              className="text-black hover:text-white -mt-1"
            >
              <svg
                className="w-7 h-7"
                aria-hidden="true"
